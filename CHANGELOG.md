...
## [2.0.0](https://github.com/bc-solutions-coder/wallow/compare/v1.2.1...v2.0.0) (2026-03-30)
...
* .NET 10 modernization - HybridCache, OTel upgrades, tenant rate limiting, FrozenDictionary ([766fd5c](https://github.com/bc-solutions-coder/wallow/commit/766fd5cdefbefec953b05bba16d1bdd1bf0c362e))
* add architecture test auto-discovery and security scanning CI ([069bb8a](https://github.com/bc-solutions-coder/wallow/commit/069bb8a4cec426139f3d014472012336b579676a))
* add database migration init container with EF Core bundles ([75e0283](https://github.com/bc-solutions-coder/wallow/commit/75e0283da1823e4b4deaa85130d65bd2429e0cc3))
* add EF Core compiled queries across all modules and benchmarks ([4b819af](https://github.com/bc-solutions-coder/wallow/commit/4b819af8a7b582edefeaefd7d171695c95b7acca))
* add EF Core migrations for Identity, Storage, and Communications ([64c4a14](https://github.com/bc-solutions-coder/wallow/commit/64c4a14e0b2ba3550ec31994b9cfbfac6ec146d8))
* add notifications, inquiries, and billing enhancements ([c4a48b1](https://github.com/bc-solutions-coder/wallow/commit/c4a48b1a2e784756c3ac7d62f9a4119f4b17fb5e))
* add Polly resilience integration across all HTTP clients ([9cc22ac](https://github.com/bc-solutions-coder/wallow/commit/9cc22acbad3604f926a1d3be5daa450502a65a4d))
* add repo promotion assets, GitHub Pages deploy, SEO meta tags, and Why Wallow README section ([#11](https://github.com/bc-solutions-coder/wallow/issues/11)) ([6b09247](https://github.com/bc-solutions-coder/wallow/commit/6b09247d2876f38099a0ca2a016c61bb32cb0dab))
* add TenantAwareDbContext base class and migrate all module DbContexts ([d6ef45d](https://github.com/bc-solutions-coder/wallow/commit/d6ef45ddd5c0af2e1e86cb01b67432eb071d5829))
* add Wolverine tenant context propagation via ITenantContextSetter and stamping/restoring middlewares ([d88ae88](https://github.com/bc-solutions-coder/wallow/commit/d88ae88cf58948b0ec06fad3c64b5d8d2340e7a7))
* **api:** add config-driven module toggles ([26db34d](https://github.com/bc-solutions-coder/wallow/commit/26db34d08b02f4f204c03ed81b5c62a386d4373a))
* **api:** add CSRF protection with antiforgery middleware and explicit controller postures ([fb984c1](https://github.com/bc-solutions-coder/wallow/commit/fb984c186e6735c94bdf9ee221580e7180a5b900))
* **api:** add Microsoft.FeatureManagement.AspNetCore package ([01ac30e](https://github.com/bc-solutions-coder/wallow/commit/01ac30e08e17105503df608c707436deb5e99fd3))
* **api:** integrate Microsoft.FeatureManagement for module gating ([1f16555](https://github.com/bc-solutions-coder/wallow/commit/1f16555b0425d6b91e9c21a8704bd9dd32fd0b3b))
* **billing:** implement settings pattern as reference implementation ([1a856e2](https://github.com/bc-solutions-coder/wallow/commit/1a856e226501ffe4e9688fc8675445a90eba1721))
* **billing:** implement settings pattern with keyed DI, integration tests, and shared infrastructure fixes ([ed4d96f](https://github.com/bc-solutions-coder/wallow/commit/ed4d96ffe5bcc634b4501e431c8870cf12401ec3))
* CI/CD and deployment hardening - pin images, add healthcheck, fix trivy, prod compose ([e3e947a](https://github.com/bc-solutions-coder/wallow/commit/e3e947ad6fb2bd2106dfffa57300731188f9c22e))
* **communications:** add email provider abstraction with IEmailProvider interface ([58160fe](https://github.com/bc-solutions-coder/wallow/commit/58160fea97ac974be821ef631d0a2f1fc75f5444))
* **communications:** add email retry background job ([7415a44](https://github.com/bc-solutions-coder/wallow/commit/7415a44a6ad064df4e7d491d394335c33f461616))
* **communications:** add enhanced system inbox with archive and expiry ([333e1ea](https://github.com/bc-solutions-coder/wallow/commit/333e1ea6168e2c2f1601957fc39cc8fc222a0565))
* **communications:** add messaging infrastructure, API, and SMS domain ([c47b746](https://github.com/bc-solutions-coder/wallow/commit/c47b7461612e77c9fea592ed37e32e78e88742c8))
* **communications:** add messaging integration events, handlers, and integration tests ([0e5b130](https://github.com/bc-solutions-coder/wallow/commit/0e5b1302a8512f6f32501959b90d7d254320a940))
* **communications:** add push notifications with FCM/APNs/WebPush and unified notification settings ([458af46](https://github.com/bc-solutions-coder/wallow/commit/458af4657db4398176d511fef50d705865cec66a))
* **communications:** add SMS channel with Twilio provider ([ab224fe](https://github.com/bc-solutions-coder/wallow/commit/ab224feefc7a7478870e00ed8a1ea47ccfde8af0))
* **communications:** add test coverage for SMS, notifications, and test builders ([e6519ec](https://github.com/bc-solutions-coder/wallow/commit/e6519ec89f819c54f544ce9300769efb81184106))
* **communications:** add unified channel preference model with data migration ([c494034](https://github.com/bc-solutions-coder/wallow/commit/c494034cd3eb69cbb045eda0fba72b40dcce9dbf))
* **communications:** add user-to-user messaging application layer ([65fbfe0](https://github.com/bc-solutions-coder/wallow/commit/65fbfe0ccf605679c23839918680bd9aaccf4881))
* **communications:** add user-to-user messaging domain model ([511c089](https://github.com/bc-solutions-coder/wallow/commit/511c0895f886b7d1fe5fd1688e3c1990ff13cb2a))
* **communications:** split into notifications, messaging, and announcements modules ([b50c961](https://github.com/bc-solutions-coder/wallow/commit/b50c9611e8b4a33b6fd6323460dd638bb210ca0c))
* complete phase 1 critical security and runtime crash fixes ([01ade8c](https://github.com/bc-solutions-coder/wallow/commit/01ade8c45340ef112cc4d71229ba384f85260384))
* critical fixes for v0.3.0 release (phase 1 audit remediation) ([aad79dd](https://github.com/bc-solutions-coder/wallow/commit/aad79dd45e69f04f1dd81406464c3a8ded72d74b))
* **docs:** add DocFX docs site with branding-driven theme ([e1e6e1d](https://github.com/bc-solutions-coder/wallow/commit/e1e6e1d97123df415550f14ac5804cbcf6d917d9))
* Foundry modular monolith platform v0.1.0 ([a089596](https://github.com/bc-solutions-coder/wallow/commit/a08959608943b4ec31f67e1c77d761ab264d166d))
* **identity:** add 27 missing scopes to ApiScopes, ApiScopeSeeder, and update tests ([d9bdcf0](https://github.com/bc-solutions-coder/wallow/commit/d9bdcf031994e6be21f5fa9e3f11d4e40ae95e9f))
* **identity:** add ClientsController, remove Keycloak, update tests and config ([57bc0b8](https://github.com/bc-solutions-coder/wallow/commit/57bc0b8a0d8317f5d555da5ab6e7c0c6a9e021cb))
* **identity:** add developer self-service DCR proxy with app-* prefix, scope whitelist, and rate limiting ([2f4c940](https://github.com/bc-solutions-coder/wallow/commit/2f4c940a4f88e8d05d7c29d0d84c72562c53ecc7))
* **identity:** add explicit admin permission listing and service account permissions ([ec8cbcf](https://github.com/bc-solutions-coder/wallow/commit/ec8cbcf441070ed816bf8c42202f8fbad6505e53))
* **identity:** add IDeveloperAppService and KeycloakDeveloperAppService for DCR proxy ([dfc24b6](https://github.com/bc-solutions-coder/wallow/commit/dfc24b632ab0877259f8984c89eb8d33c1d4ab9b))
* **identity:** add OpenIddict and ASP.NET Core Identity foundation entities and migration ([d104af9](https://github.com/bc-solutions-coder/wallow/commit/d104af9a9df6fd7ebe56630870e0e2bc84193832))
* **identity:** add OpenIddict auth controllers and update auth pipeline ([9c64a7b](https://github.com/bc-solutions-coder/wallow/commit/9c64a7b769dc37bb206f4e2c6d5bdd8540569d52))
* **identity:** add OpenIddict auth, MFA, passwordless login, and Blazor apps ([8313e39](https://github.com/bc-solutions-coder/wallow/commit/8313e39994553be2e790ca8a2fee6732c3fc44db))
* **identity:** add PostgreSQL persistence for API keys with Valkey read-through cache ([20cac55](https://github.com/bc-solutions-coder/wallow/commit/20cac552b143c0e616139fd44e231ef5aa648405))
* **identity:** add TenantId.Platform sentinel unit tests ([5a5b862](https://github.com/bc-solutions-coder/wallow/commit/5a5b862e58972544dcb478f14621521a848e7cea))
* **identity:** align FoundryUser with spec and add Organization domain tests ([846126c](https://github.com/bc-solutions-coder/wallow/commit/846126c69f41649b6beed9c3aa5af29d73c2a348))
* **identity:** allow HTTP for OpenIddict in development environment ([d50f90f](https://github.com/bc-solutions-coder/wallow/commit/d50f90f14579e5b5f6da6d296bd9179ad6fdd9f2))
* **identity:** harden API key security — extract ScopePermissionMapper, fix revocation race condition, add max key limit ([e533567](https://github.com/bc-solutions-coder/wallow/commit/e533567b54c1b0fa120b04a514bda099872a8055))
* **identity:** implement auth security hardening ([94e132e](https://github.com/bc-solutions-coder/wallow/commit/94e132e52cf8a4ab358106a3616cdc0d9363c638))
* **identity:** implement dynamic client registration (DCR) ([69f9130](https://github.com/bc-solutions-coder/wallow/commit/69f9130c32d8dabf8156d8d461f9bf467eb79989))
* **identity:** implement MFA overhaul with partial-auth sessions ([52ea8b2](https://github.com/bc-solutions-coder/wallow/commit/52ea8b2cf593d23594543f2fd14d52a111389a5b))
* **identity:** replace Keycloak service account, developer app, and SSO services with OpenIddict implementations ([91c3eaf](https://github.com/bc-solutions-coder/wallow/commit/91c3eafff589a23af8da470d185ffb3b9a311d55))
* **identity:** replace Keycloak user and organization services with ASP.NET Core Identity implementations ([d72c06f](https://github.com/bc-solutions-coder/wallow/commit/d72c06fba92954dace2b343192eb29f328c7dd6e))
* **identity:** repoint SCIM services to Identity, simplify middleware, remove Keycloak remnants ([2596889](https://github.com/bc-solutions-coder/wallow/commit/25968899933ec52df6d4ed21b4f587979e1eecdf))
* implement security hardening across all modules ([3bba8cc](https://github.com/bc-solutions-coder/wallow/commit/3bba8cc5d6e5e2b8683f614ec4aac10729a2a7ab))
* implement security hardening from sweep 2 across all modules ([9a02584](https://github.com/bc-solutions-coder/wallow/commit/9a0258414ee8ec203b8e5cfd46f183db48a433d5))
* **inquiries:** add domain layer with Inquiry aggregate root ([fff72c6](https://github.com/bc-solutions-coder/wallow/commit/fff72c61266c117d0df819f190cd08ec4e4d9207))
* **inquiries:** add inquiry comments feature ([45694fb](https://github.com/bc-solutions-coder/wallow/commit/45694fbb94486f6555526c32a449ab9b3a59be01))
* **inquiries:** add scopes, permissions, and overhaul inquiry submission ([ce9b315](https://github.com/bc-solutions-coder/wallow/commit/ce9b315b21663529f0ec1ecf190afda66d50c616))
* **inquiries:** add user inquiry view and read scope ([1a92465](https://github.com/bc-solutions-coder/wallow/commit/1a92465a14df19a7daa66ea8361d8024fb8cc16c))
* **inquiries:** create Inquiries module project structure ([96ad648](https://github.com/bc-solutions-coder/wallow/commit/96ad648bcec51dcc6b39f0067bef3d223765abcc))
* **inquiries:** implement complete Inquiries module with application, infrastructure, and API layers ([e0f4194](https://github.com/bc-solutions-coder/wallow/commit/e0f41941cd01306a49ed745c4caf12a787be8aa9))
* integrate Microsoft.FeatureManagement for module-level feature gating ([40e11d3](https://github.com/bc-solutions-coder/wallow/commit/40e11d32735676c060f0eb256f653311b7d74a7d))
* **kernel:** enhance SettingKeyValidator with namespace validation and custom key limits ([a4427b9](https://github.com/bc-solutions-coder/wallow/commit/a4427b95b9a1fb25363c2f2be7875d4229e5e39a))
* migrate app containers to dotnet publish /t:PublishContainer ([5035d9b](https://github.com/bc-solutions-coder/wallow/commit/5035d9bbf16c1b0a5e0c91edd36bca7d685df76b))
* **notifications:** add SignalR handlers for inquiry submitted and status changed events ([e9f910b](https://github.com/bc-solutions-coder/wallow/commit/e9f910bfdc62cd32764699d5a1a5a35780ba6428))
* **notifications:** clean up event-driven architecture anti-patterns ([b6a2404](https://github.com/bc-solutions-coder/wallow/commit/b6a24040ce4f7fc3e93ae508301e91a38049e6e6))
* **observability:** comprehensive observability improvements to achieve 10/10 score ([a22cdeb](https://github.com/bc-solutions-coder/wallow/commit/a22cdeb23b1cd5e3cb69e55207a8fe210fdda91b))
* phase 2 security hardening (SCIM sanitization, IDOR fix, DebugInfo removal, HTML sanitization, HasPermission attributes) ([2cc1b75](https://github.com/bc-solutions-coder/wallow/commit/2cc1b75e2c3c58fc102cffc033c4c2274e089229))
* phase 4 code quality and DRY improvements (ResultExtensions consolidation, ICurrentUserService, TimeProvider injection, domain exceptions, AuditableEntity cleanup) ([9dd0594](https://github.com/bc-solutions-coder/wallow/commit/9dd059408f7da250a364a54fdb3fc2c6689c61a8))
* phase 5 infrastructure and DevOps improvements (DB resilience, HttpClient resilience, Wolverine idempotency, CI/CD hardening, Docker pinning, TenantId security) ([72084cb](https://github.com/bc-solutions-coder/wallow/commit/72084cb4830753c745341198175b07bc7ffb8507))
* phase 6 consistency and code quality improvements ([ef9f2c1](https://github.com/bc-solutions-coder/wallow/commit/ef9f2c136d865705767c82aaec0bc3f61dd7c1ce))
* **realtime:** add SSE infrastructure with audience-scoped filtering ([b0ec7dc](https://github.com/bc-solutions-coder/wallow/commit/b0ec7dc8a54cba1aa0974a90558b45ef5f9fa961))
* remove Showcases module ([4404989](https://github.com/bc-solutions-coder/wallow/commit/4404989dd1f0736db9161071c26d76e37b884980))
* retire Configuration module, migrate custom fields to Billing, complete decentralized settings ([e6cf130](https://github.com/bc-solutions-coder/wallow/commit/e6cf130098b40780aebadb8e2baded57b45de335))
* roll out settings pattern to identity, storage, and communications modules ([586dd42](https://github.com/bc-solutions-coder/wallow/commit/586dd42a880a5ece7f2482f1296bf8ad393cc61a))
* **security:** add JWT auth, tenant isolation, and permission guards for P0/P1 vulnerabilities ([05ca6b8](https://github.com/bc-solutions-coder/wallow/commit/05ca6b8706f149040fafbfe6e2566570bec7f5ee))
* **security:** remediate P0/P1 findings from security sweep 2 ([cad906a](https://github.com/bc-solutions-coder/wallow/commit/cad906a9b980f6589bfaaf147a6ba3c8fbba4de5))
* self-contained API container with migrations, cert gen, and multi-arch support ([b022cb9](https://github.com/bc-solutions-coder/wallow/commit/b022cb9d9682065b33956d5c36f9e0105a0c95ab))
* **shared-infra:** add settings entities, repositories, cached service, and DI wiring ([9cb8b0f](https://github.com/bc-solutions-coder/wallow/commit/9cb8b0f2c10f093b265de430fa4edf2fd4be00e6))
* **shared-kernel:** add setting definitions and interfaces for decentralized settings ([049fe6d](https://github.com/bc-solutions-coder/wallow/commit/049fe6d6443a7f9af822a51d2c4fb8a49904c1db))
* **showcases:** implement showcases module with CRUD API, domain, infrastructure, and tests ([21ffd93](https://github.com/bc-solutions-coder/wallow/commit/21ffd937787903f2bd8c0881fe9c56f7bee41719))
* split Shared.Infrastructure into Core, Workflows, BackgroundJobs, and Plugins sub-projects ([0ebcec1](https://github.com/bc-solutions-coder/wallow/commit/0ebcec16d599efa02e544536e184c8dff25ea850))
* **storage:** add virus/malware scanning for file uploads via ClamAV ([bb320df](https://github.com/bc-solutions-coder/wallow/commit/bb320df6a6854ecf9711896f9397a19a96b27904))
* **storage:** begin optional ClamAV with design and config refactor ([a516142](https://github.com/bc-solutions-coder/wallow/commit/a5161421bbbecdd4654a44a76cc0157de9c2934a))
* trunk-based workflow with release-please semantic releases ([16aed5c](https://github.com/bc-solutions-coder/wallow/commit/16aed5c46913add11bcda7f75135a45249efb42a))
* unified docker production stack with custom images ([2c3976d](https://github.com/bc-solutions-coder/wallow/commit/2c3976d76b5cac7011d9264d21f88d7e9bf5ab82))
* verify resilience OTel integration and add logging callback tests ([b19eefb](https://github.com/bc-solutions-coder/wallow/commit/b19eefb39f972a6f8ea7dd18b453e45d34c669d3))
...
* add last-release-sha to release-please config after history rewrite ([117adcd](https://github.com/bc-solutions-coder/wallow/commit/117adcdd6bbfbb871630fd9a27b131afb92bf880))
* add missing project references for shared test coverage in Rider ([7324437](https://github.com/bc-solutions-coder/wallow/commit/732443717c3fb4a0b37be92fa90a91620e964bbd))
* add proper health checks to Auth/Web apps and fix docker healthcheck URLs ([aa7849b](https://github.com/bc-solutions-coder/wallow/commit/aa7849b4a94a6fa524947a74382288fc55243bda))
* address remaining Qodana warning categories ([8ff6be1](https://github.com/bc-solutions-coder/wallow/commit/8ff6be154ad7ec4c7c4f013dbf63d9b49eec0a73))
* align 25 namespace declarations with directory structure (Qodana CheckNamespace) ([69d4428](https://github.com/bc-solutions-coder/wallow/commit/69d44284356e6ccf956f6828ca8fe0736a098e3d))
* align codeql config with merged resolution ([d6a46f6](https://github.com/bc-solutions-coder/wallow/commit/d6a46f604e9462e7849afa54c92eb772cbe3963e))
* **auth:** prevent open-redirect via ReturnUrl in Blazor pages ([#13](https://github.com/bc-solutions-coder/wallow/issues/13)) ([f54d0a5](https://github.com/bc-solutions-coder/wallow/commit/f54d0a5fc9a89ef2416f7d1442ec91936cb2e9ef))
...
* **ci:** correct garage service name in docker compose build ([c4db4c8](https://github.com/bc-solutions-coder/wallow/commit/c4db4c8131579b5bb4ee0551793acfd0230cdbc5))
* **ci:** exclude benchmarks project from test discovery ([7ba6953](https://github.com/bc-solutions-coder/wallow/commit/7ba69530ac228cd0849e1eac662a4895a2559a4e))
* **ci:** fix release-please auto-merge template parsing error ([f3202da](https://github.com/bc-solutions-coder/wallow/commit/f3202daaa9c00db48af0ae634028d76f3c014070))
...
* **ci:** restore dotnet-ef tool before publishing container images ([10c8f1e](https://github.com/bc-solutions-coder/wallow/commit/10c8f1e64801b864fd61f1bdc1a63dc36abd08b6))
* **ci:** set codeql build-mode to manual ([344281d](https://github.com/bc-solutions-coder/wallow/commit/344281df6df76b9cd668bf84ec232368d5a5f96f))
* **ci:** update docker image build to use dotnet publish /t:PublishContainer ([427e066](https://github.com/bc-solutions-coder/wallow/commit/427e06642637b561455d838e18efa07cad2d2fdf))
* **communications:** resolve CS8604 null-dereference warning in SmtpEmailProvider ([fa0c510](https://github.com/bc-solutions-coder/wallow/commit/fa0c510b9227da8edcc8e67bc93af2b7305c7b8e))
* **deploy:** make dockhand stack self-contained and fix container failures ([69e3e11](https://github.com/bc-solutions-coder/wallow/commit/69e3e1197e839824c37fed9124440ae9d576fc4c))
* **deps:** bump resilience packages to satisfy Elsa 3.6.0 transitive dependency ([23481a0](https://github.com/bc-solutions-coder/wallow/commit/23481a095b3365b08bce51dc78da941d37d1e94f))
* **deps:** resolve Humanizer version conflict and upgrade WireMock.Net to 2.0.0 ([23481a0](https://github.com/bc-solutions-coder/wallow/commit/23481a095b3365b08bce51dc78da941d37d1e94f))
* **e2e:** improve Blazor login reliability with circuit-aware waits ([722d0b7](https://github.com/bc-solutions-coder/wallow/commit/722d0b7e8ecb02add3cf27fd4c81998a5e972f1a))
* exclude only docs/plans instead of entire docs directory in .dockerignore ([#9](https://github.com/bc-solutions-coder/wallow/issues/9)) ([2b0980e](https://github.com/bc-solutions-coder/wallow/commit/2b0980ec32d14f97eccfe719b94b4109c1d75041))
* **identity:** resolve scoped service DI violation in SessionActivityMiddleware ([c8e2249](https://github.com/bc-solutions-coder/wallow/commit/c8e2249863b88f9c65aa99ee2123b7942de9f763))
* **identity:** update WireMock path patterns to require leading slash ([f3129d2](https://github.com/bc-solutions-coder/wallow/commit/f3129d2b99fd7cb217b31651aa8c2546a07ec343))
* **identity:** validate API key scopes against user's current permissions ([482dcd1](https://github.com/bc-solutions-coder/wallow/commit/482dcd13d37ddc8efc3ab2264fb8ca9ed3559217))
* **kernel:** add missing xml doc on ForbiddenAccessException ([00814ad](https://github.com/bc-solutions-coder/wallow/commit/00814ad9164e3e88e6fb44dbadb20656f60c0afb))
* make RabbitMQ health check conditional and fix grafana-lgtm health check ([9172603](https://github.com/bc-solutions-coder/wallow/commit/917260365a4ccff43f1d2c1f0e594b7c95e2e7bc))
* phase 3 broken workflows and functional bugs ([b42a897](https://github.com/bc-solutions-coder/wallow/commit/b42a8976378933878f4ede4825c1d4cf4c063830))
* prevent recursive bin/Debug nesting in build output ([79bfaa6](https://github.com/bc-solutions-coder/wallow/commit/79bfaa668da69c4ac51c4ebca22789c794d836c0))
* reduce flakiness in AuditInterceptorTests by sharing Postgres container ([725aae8](https://github.com/bc-solutions-coder/wallow/commit/725aae8b24f0918feaf13ec1b8febe87f9e64a1b))
* remove 24 redundant ToString() calls flagged by Qodana UseNameOfInsteadOfToString ([de12631](https://github.com/bc-solutions-coder/wallow/commit/de12631646646ad2a950b1652824ed99878e3a48))
...
* remove redundant namespace qualifiers across codebase ([98e9212](https://github.com/bc-solutions-coder/wallow/commit/98e921275e0f58d9949b2864505ba485f2959bcb))
* remove unnecessary using directive in StorageDbContextFactoryTests ([ce20061](https://github.com/bc-solutions-coder/wallow/commit/ce20061f99e76268857cf92de93424144c6ff730))
* remove unnecessary using directive in StorageExtensionsTests ([2b35225](https://github.com/bc-solutions-coder/wallow/commit/2b35225d98cb60b57aa06ce787f0fdb76261cec4))
* remove unnecessary using directives (IDE0005) across test projects ([8f958a7](https://github.com/bc-solutions-coder/wallow/commit/8f958a7123ad82cbd136308ab110f747160d7772))
* resolve 167 codebase audit findings across all modules ([#18](https://github.com/bc-solutions-coder/wallow/issues/18)) ([261c433](https://github.com/bc-solutions-coder/wallow/commit/261c4334b8ca61a404cb0e2bb7baa5ccb7ee169a))
* resolve codeql build errors from analyzer rules ([2983e05](https://github.com/bc-solutions-coder/wallow/commit/2983e0577f58686acbf568b7e88dfe27cbc01f34))
* resolve qodana phase 2 bug risk warnings across all modules ([bed2e86](https://github.com/bc-solutions-coder/wallow/commit/bed2e86ad3332d08ec89dafd3815434103c10169))
* resolve qodana phase 3 code hygiene warnings across all modules ([6ac5d0b](https://github.com/bc-solutions-coder/wallow/commit/6ac5d0b6e549c48b95de282aa0026807b1c866c4))
* restore garage docker files accidentally deleted in 2c3976d7 ([10cecb6](https://github.com/bc-solutions-coder/wallow/commit/10cecb664c4be30f3ee4f53bdb2eabe4bdd6ba04))
* set DOTNET_BUNDLE_EXTRACT_BASE_DIR for migration bundles in read-only containers ([1fa8cee](https://github.com/bc-solutions-coder/wallow/commit/1fa8ceec642917dc2932f21363778704ec25f047))
...
* **showcases:** remove [AllowAnonymous] from read endpoints ([9f9abbb](https://github.com/bc-solutions-coder/wallow/commit/9f9abbbe8ede98694465b753e31d2da17a6e91c9))
* suppress 58 unused positional record property warnings (Qodana NotAccessedPositionalProperty.Global) ([7783d53](https://github.com/bc-solutions-coder/wallow/commit/7783d53eb784606240a71c36ffaab0d63f826a57))
* suppress 59 unused auto-property accessor warnings (Qodana UnusedAutoPropertyAccessor.Global) ([17d1fa3](https://github.com/bc-solutions-coder/wallow/commit/17d1fa367ebe52ed0a96b3f7a45939cad478fe5b))
* suppress and resolve remaining small Qodana warning categories (~45 issues) ([a804ad5](https://github.com/bc-solutions-coder/wallow/commit/a804ad5cd3adff7b00a1b92b656ec113a573794f))
* suppress unused EF Core constructors and remove dead code (Qodana UnusedMember.Local) ([74fdbd3](https://github.com/bc-solutions-coder/wallow/commit/74fdbd30eba7a7981a6e9bdf5df7f32f16423d67))
...
* phase 3 performance optimization (NoTracking, pagination, Redis consolidation, cache fix, SMTP reuse, FlushUsageJob optimization) ([95dba33](https://github.com/bc-solutions-coder/wallow/commit/95dba33aff53bfa3e61abfe0c3bf08c6731164a1))


### Code Refactoring

* rename project from Foundry to Wallow ([328ef90](https://github.com/bc-solutions-coder/wallow/commit/328ef90e1e4c0a936cd02aafeeecbabdee266aec))

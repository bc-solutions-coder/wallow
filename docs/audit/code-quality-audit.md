...
Wallow is a well-architected .NET 10 modular monolith that demonstrates strong adherence to Clean Architecture, DDD, and CQRS principles. The codebase has excellent module isolation, rich domain models with proper state machines, a solid Result pattern, and comprehensive test coverage. The findings below represent refinement opportunities rather than fundamental design flaws.
...
**Remediation:** Extract `ResultExtensions` to `Wallow.Shared.Kernel` (which already references `Microsoft.AspNetCore.App`), or create a thin `Wallow.Shared.Api` project. All module API layers should reference the shared implementation.
...
- `src/Modules/Billing/Wallow.Billing.Api/Controllers/InvoicesController.cs:178`
- `src/Modules/Billing/Wallow.Billing.Api/Controllers/PaymentsController.cs:91`
- `src/Modules/Billing/Wallow.Billing.Api/Controllers/SubscriptionsController.cs:115`
- `src/Modules/Storage/Wallow.Storage.Api/Controllers/StorageController.cs:301`
- `src/Modules/Communications/Wallow.Communications.Api/Controllers/ConversationsController.cs:171`
- `src/Modules/Communications/Wallow.Communications.Api/Controllers/NotificationsController.cs:136`
- `src/Modules/Communications/Wallow.Communications.Api/Controllers/AnnouncementsController.cs:86`
- `src/Modules/Communications/Wallow.Communications.Api/Controllers/EmailPreferencesController.cs:85`
- `src/Modules/Identity/Wallow.Identity.Api/Controllers/ApiKeysController.cs:196`
- `src/Modules/Configuration/Wallow.Configuration.Api/Controllers/FeatureFlagsController.cs:223`
...
**Remediation:** The project already has `ICurrentUserService` in `src/Modules/Identity/Wallow.Identity.Application/Interfaces/ICurrentUserService.cs`. Inject it into controllers instead of duplicating claim parsing. All modules should use `ICurrentUserService` and return 401 when UserId is null.

---

#### H3. `IAuditableEntity` Interface Defined But Never Implemented

**File:** `src/Shared/Wallow.Shared.Kernel/Domain/AuditableEntity.cs:40-51`
...
**Examples:**
- `src/Modules/Billing/Wallow.Billing.Domain/Entities/Invoice.cs:154` - `PaidAt = DateTime.UtcNow`
- `src/Modules/Billing/Wallow.Billing.Domain/Entities/Subscription.cs:142` - `CancelledAt = DateTime.UtcNow`
- `src/Modules/Billing/Wallow.Billing.Domain/Entities/Payment.cs:85` - `CompletedAt = DateTime.UtcNow`
- `src/Modules/Communications/Wallow.Communications.Domain/Channels/Email/Entities/EmailMessage.cs:49`
- `src/Modules/Configuration/Wallow.Configuration.Domain/Entities/FeatureFlag.cs:50,70,95,107,124,146`
- `src/Modules/Storage/Wallow.Storage.Domain/Entities/StorageBucket.cs:52`
- `src/Modules/Identity/Wallow.Identity.Domain/Entities/ScimConfiguration.cs:47,66,112,118`
- `src/Shared/Wallow.Shared.Kernel/Domain/AuditableEntity.cs:25,34`
...
**File:** `src/Shared/Wallow.Shared.Kernel/MultiTenancy/ITenantScoped.cs`
...
**File:** `src/Shared/Wallow.Shared.Kernel/Wallow.Shared.Kernel.csproj`
...
**Remediation:** Split `Wallow.Shared.Kernel` into:
- `Wallow.Shared.Kernel.Domain` - Entity, ValueObject, AggregateRoot, Result (zero dependencies)
- `Wallow.Shared.Kernel` - Everything else (ID converters, Wolverine extensions, validation)
...
**Files:**
- `src/Modules/Storage/Wallow.Storage.Domain/Entities/StoredFile.cs:13` - extends `Entity<StoredFileId>`
- `src/Modules/Storage/Wallow.Storage.Domain/Entities/StorageBucket.cs:16` - extends `Entity<StorageBucketId>`
...
**File:** `src/Modules/Storage/Wallow.Storage.Domain/Entities/StorageBucket.cs:21,43-45,67-68`
...
**Files:**
- `src/Modules/Billing/Wallow.Billing.Application/Queries/GetAllInvoices/GetAllInvoicesQuery.cs` - No pagination parameters
- `src/Modules/Billing/Wallow.Billing.Api/Controllers/InvoicesController.cs:44-51` - Returns `IReadOnlyList<InvoiceResponse>` with no page/size
...
**Remediation:** Use the existing `PagedResult<T>` from `Wallow.Shared.Kernel.Pagination` and add `page`/`pageSize` parameters.

---

#### M7. `FeatureFlag` and `FeatureFlagOverride` Manage Own Timestamps

**File:** `src/Modules/Configuration/Wallow.Configuration.Domain/Entities/FeatureFlag.cs`
...
**File:** `src/Modules/Billing/Wallow.Billing.Domain/Entities/Payment.cs:61-69`
...
**File:** `src/Modules/Billing/Wallow.Billing.Api/Wallow.Billing.Api.csproj`

```xml
<ItemGroup>
    <ProjectReference Include="..\Wallow.Billing.Application\Wallow.Billing.Application.csproj" />
</ItemGroup>
```
...
**File:** `src/Modules/Communications/Wallow.Communications.Domain/Messaging/Entities/Conversation.cs:81-93`
...
**Files:**
- `src/Modules/Communications/Wallow.Communications.Domain/Messaging/Entities/Conversation.cs:62,70,83` - uses `InvalidOperationException`
- `src/Modules/Billing/Wallow.Billing.Domain/Entities/Invoice.cs` - uses `InvalidInvoiceException` (extends `DomainException`)
- `src/Modules/Configuration/Wallow.Configuration.Domain/Entities/FeatureFlag.cs:110,128` - uses `InvalidOperationException`
...
**File:** `src/Modules/Storage/Wallow.Storage.Domain/Entities/StoredFile.cs:30-54`
...
1. **Excellent module isolation** - No cross-module references detected. All inter-module communication goes through `Wallow.Shared.Contracts` events. Architecture tests in `tests/Wallow.Architecture.Tests/ModuleIsolationTests.cs` enforce this.

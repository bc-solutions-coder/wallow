...
### Keycloak JWT Validation Failures
...
**Keycloak not ready:**
Keycloak takes 1-2 minutes on first boot:
```bash
# Wait for startup
...
**User missing role in Keycloak:**
1. Open Keycloak Admin Console
2. Go to Users > Select user > Role Mappings
3. Add required realm roles (e.g., `admin`, `billing-manager`)
...
2. Add `organization` attribute with the tenant GUID

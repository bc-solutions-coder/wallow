...
public class ScopePermissionMapperTests
{
    ...
    [Fact]
    public void MapScopeToPermission_BillingRead_ReturnsBillingRead()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("billing.read");

        result.Should().Be(PermissionType.BillingRead);
    }

    [Fact]
    public void MapScopeToPermission_BillingManage_ReturnsBillingManage()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("billing.manage");

        result.Should().Be(PermissionType.BillingManage);
    }

    [Fact]
    public void MapScopeToPermission_InvoicesRead_ReturnsInvoicesRead()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("invoices.read");

        result.Should().Be(PermissionType.InvoicesRead);
    }

    [Fact]
    public void MapScopeToPermission_InvoicesWrite_ReturnsInvoicesWrite()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("invoices.write");

        result.Should().Be(PermissionType.InvoicesWrite);
    }

    [Fact]
    public void MapScopeToPermission_PaymentsRead_ReturnsPaymentsRead()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("payments.read");

        result.Should().Be(PermissionType.PaymentsRead);
    }

    [Fact]
    public void MapScopeToPermission_PaymentsWrite_ReturnsPaymentsWrite()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("payments.write");

        result.Should().Be(PermissionType.PaymentsWrite);
    }

    [Fact]
    public void MapScopeToPermission_SubscriptionsRead_ReturnsSubscriptionsRead()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("subscriptions.read");

        result.Should().Be(PermissionType.SubscriptionsRead);
    }

    [Fact]
    public void MapScopeToPermission_SubscriptionsWrite_ReturnsSubscriptionsWrite()
    {
        string? result = ScopePermissionMapper.MapScopeToPermission("subscriptions.write");

        result.Should().Be(PermissionType.SubscriptionsWrite);
    }

...
#pragma warning restore CA1001
    ...
    {
        Wallow.Shared.Kernel.Results.Result<Showcase> result = Showcase.Create(
            title,
            "A description",
            category,
            demoUrl,
    ...
    public async Task GetAllAsync_WithTagFilter_ReturnsOnlyMatchingTag()
    {
        ...
        Wallow.Shared.Kernel.Results.Result<Showcase> withTagResult = Showcase.Create(
            $"Tagged-{Guid.NewGuid()}",
            null,
        ...
        Wallow.Shared.Kernel.Results.Result<Showcase> withoutTagResult = Showcase.Create(
    ...
    public async Task GetAllAsync_ReturnsShowcasesOrderedByDisplayOrderThenTitle()
    {
        ...
        Wallow.Shared.Kernel.Results.Result<Showcase> b2 = Showcase.Create(
            $"B-{suffix}", null, ShowcaseCategory.Tool, "https://demo.example.com", null, null, null, 2, true);
        Wallow.Shared.Kernel.Results.Result<Showcase> a1 = Showcase.Create(
            $"A-{suffix}", null, ShowcaseCategory.Tool, "https://demo.example.com", null, null, null, 1, true);
        Wallow.Shared.Kernel.Results.Result<Showcase> c1 = Showcase.Create(

...
namespace Foundry.Storage.Tests.Api.Extensions;
...
public class ResultExtensionsTests
{
    ...
    {
        Result result = Result.Failure(Error.NotFound("Bucket", "test"));
        ...
        problem.Extensions["code"].Should().Be("Bucket.NotFound");
    }

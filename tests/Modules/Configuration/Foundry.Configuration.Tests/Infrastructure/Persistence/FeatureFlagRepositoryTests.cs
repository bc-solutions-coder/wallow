...
public class FeatureFlagRepositoryTests : DbContextIntegrationTestBase<ConfigurationDbContext>
{
    public FeatureFlagRepositoryTests(PostgresContainerFixture fixture) : base(fixture) { }

...
public class ApiKeysControllerTests
{
    ...
    public ApiKeysControllerTests()
    {
        ...
        _currentUserService = Substitute.For<Wallow.Shared.Kernel.Services.ICurrentUserService>();
        ...
        _controller = new ApiKeysController(_apiKeyService, scopeSubsetValidator, _tenantContext, _currentUserService, configuration);
    ...
    public async Task ListApiKeys_MapsAllMetadataFields()
    {
        ...
        response[0].Scopes.Count.Should().Be(2);
    }

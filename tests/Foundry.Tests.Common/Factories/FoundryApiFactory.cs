...
namespace Foundry.Tests.Common.Factories;
...
public class FoundryApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    {
        Console.WriteLine("[FoundryApiFactory] DisposeAsync called");
        ...
        {
            Console.WriteLine($"[FoundryApiFactory] Host stop error: {ex.Message}");
        }
        ...
        {
            Console.WriteLine($"[FoundryApiFactory] Base dispose error: {ex.Message}");
        }
        ...
        Console.WriteLine("[FoundryApiFactory] Disposing containers...");
        ...
        Console.WriteLine("[FoundryApiFactory] Containers disposed");
    }
    ...
    private static async Task DisposeContainerSafelyAsync(IAsyncDisposable container, string name)
    {
        try
        {
            ...
            Console.WriteLine($"[FoundryApiFactory] {name} disposed successfully");
        }
        catch (Exception ex)
        {
            Console.WriteLine($"[FoundryApiFactory] {name} dispose error: {ex.Message}");
        }
    }

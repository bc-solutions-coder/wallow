...
class CacheTests(unittest.TestCase):
    def setUp(self):
        self.main = dict(GITHUB_EVENT_NAME='push', GITHUB_REF='refs/heads/main', MAIN_CACHE='true', TAILNET_RESULT='success', TURBO_API='https://cache.example.test', TURBO_TEAM='ci', TURBO_TOKEN='test-value')
    ...
    def test_only_configured_main_push_can_probe_private_cache(self):
        ...
        for override in [{'GITHUB_EVENT_NAME': 'pull_request'}, {'GITHUB_EVENT_NAME': 'schedule'}, {'GITHUB_REF': 'refs/heads/feature'}, {'MAIN_CACHE': ''}, {'TAILNET_RESULT': 'failure'}, {'TURBO_TOKEN': ''}]:
            def probe(_):
    ...
    def test_unavailable_cache_falls_back_without_credentials_in_diagnostics(self):
        ...
        for secret in ['https://cache.example.test', 'test-value']:

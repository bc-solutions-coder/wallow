...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foundry.Storage.Domain.Entities.StorageBucket", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Foundry.Storage.Domain.Entities.StoredFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Foundry.Storage.Domain.Entities.StorageBucket", b =>
                {
                    b.OwnsOne("Foundry.Storage.Domain.ValueObjects.RetentionPolicy", "Retention", b1 =>
                        {
            ...
            modelBuilder.Entity("Foundry.Storage.Domain.Entities.StoredFile", b =>
                {
                    b.HasOne("Foundry.Storage.Domain.Entities.StorageBucket", null)
                        .WithMany()

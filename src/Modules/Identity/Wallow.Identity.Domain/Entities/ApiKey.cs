...
public sealed class ApiKey : AuditableEntity<ApiKeyId>, ITenantScoped
{
    ...
    /// <summary>
    /// The service account (Keycloak client ID) this key authenticates as.
    /// </summary>
        ...
        TimeProvider timeProvider)
    {
        if (string.IsNullOrWhiteSpace(serviceAccountId))
        {
            throw new BusinessRuleException(
                "Identity.ServiceAccountIdRequired",
        ...
        {
            throw new BusinessRuleException(
                "Identity.ApiKeyDisplayNameRequired",

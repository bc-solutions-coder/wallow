...
export function parseProblemDetails(
  ...
  return new WallowError({
    ...
    title:
      typeof problem.title === "string" ? problem.title : UNKNOWN_ERROR_TITLE,
...
const SENSITIVE_MEMBERS: readonly string[] = [
  "authorization",
  "cookie",
  "set-cookie",
  "password",
...
function isSensitiveMember(member: string): boolean {
  ...
  return (
    ...
    SENSITIVE_MEMBER_FRAGMENTS.some((fragment: string) =>

...
describe("redact", () => {
  ...
  it("redacts nested objects and arrays without mutating the input", () => {
    ...
    const redacted: Record<string, unknown> = redact(input) as Record<
      string,
      unknown
    >;
    const request: Record<string, unknown> = redacted["request"] as Record<
      string,
      unknown
    >;
    const headers: Record<string, unknown> = request["headers"] as Record<
      string,
      unknown
    >;
    const events: Record<string, unknown>[] = redacted["events"] as Record<
      string,
      unknown
    >[];
    ...
    expect(
      (
        (input["request"] as Record<string, unknown>)["headers"] as Record<
          string,
          unknown
        >
      )["authorization"],

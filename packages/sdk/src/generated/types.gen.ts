 ...
 * Also used by 127 other endpoint/status combinations.
 */
...
export type OrganizationClientRegistrationResponse = {
  ...
  issuer: string;
  apiBaseUrl: string;
  telemetry?: null | TelemetryConfigurationDto;
};
...
export type OrganizationClientResponse = {
   ...
   */
  refreshTokenLifetime?: null | number | string;
  telemetry?: null | TelemetryStatusDto;
};
 ...
 * Also used by 825 other endpoint/status combinations.
 */

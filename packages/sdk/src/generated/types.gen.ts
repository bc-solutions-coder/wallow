 ...
 * Data used directly or within nested payloads by the following API operations.
 *
 * Response 200 from GET /v1/admin/announcements: List all tenant announcements.
 * Response 201 from POST /v1/admin/announcements: Create an announcement.
 * Response 200 from PUT /v1/admin/announcements/{id}: Replace announcement content and targeting.
 ...
 * Data used directly or within nested payloads by the following API operations.
 *
 * Request body for POST /v1/admin/announcements: Create an announcement.
 * Request body for PUT /v1/admin/announcements/{id}: Replace announcement content and targeting.
 */
 ...
 * Endpoint: POST /v1/announcements/{id}/dismiss.
 */

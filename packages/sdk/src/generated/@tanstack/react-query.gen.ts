...
export const organizationsGetMyOrganizationsQueryKey = (options?: Options<OrganizationsGetMyOrganizationsData>) => createQueryKey('organizationsGetMyOrganizations', options, false, ['Organizations']);

/**
 * Get all organizations that the current user belongs to.
 */
export const organizationsGetMyOrganizationsOptions = (options?: Options<OrganizationsGetMyOrganizationsData>) => queryOptions<OrganizationsGetMyOrganizationsResponse, DefaultError, OrganizationsGetMyOrganizationsResponse, ReturnType<typeof organizationsGetMyOrganizationsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await organizationsGetMyOrganizations({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: organizationsGetMyOrganizationsQueryKey(options)
});
...
export const inquiriesAddCommentMutation = (options?: Partial<Options<InquiriesAddCommentData>>): UseMutationOptions<unknown, InquiriesAddCommentError, Options<InquiriesAddCommentData>> => {
    const mutationOptions: UseMutationOptions<unknown, InquiriesAddCommentError, Options<InquiriesAddCommentData>> = {

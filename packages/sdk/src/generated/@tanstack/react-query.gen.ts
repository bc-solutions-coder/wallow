...
export const appsRegisterMutation = (options?: Partial<Options<AppsRegisterData>>): UseMutationOptions<AppsRegisterResponse, AppsRegisterError, Options<AppsRegisterData>> => {
    const mutationOptions: UseMutationOptions<AppsRegisterResponse, AppsRegisterError, Options<AppsRegisterData>> = {
        mutationFn: async (fnOptions) => await appsRegister({
            ...options,
            ...fnOptions,
            throwOnError: true
        })
...
export const appsGetUserAppsQueryKey = (options?: Options<AppsGetUserAppsData>) => createQueryKey('appsGetUserApps', options, false, ['Apps']);

export const appsGetUserAppsOptions = (options?: Options<AppsGetUserAppsData>) => queryOptions<AppsGetUserAppsResponse, DefaultError, AppsGetUserAppsResponse, ReturnType<typeof appsGetUserAppsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await appsGetUserApps({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: appsGetUserAppsQueryKey(options)
});

export const appsGetUserAppQueryKey = (options: Options<AppsGetUserAppData>) => createQueryKey('appsGetUserApp', options, false, ['Apps']);

export const appsGetUserAppOptions = (options: Options<AppsGetUserAppData>) => queryOptions<AppsGetUserAppResponse, AppsGetUserAppError, AppsGetUserAppResponse, ReturnType<typeof appsGetUserAppQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await appsGetUserApp({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: appsGetUserAppQueryKey(options)
});
...
export const clientsGetByTenantQueryKey = (options: Options<ClientsGetByTenantData>) => createQueryKey('clientsGetByTenant', options, false, ['Clients']);

export const clientsGetByTenantOptions = (options: Options<ClientsGetByTenantData>) => queryOptions<ClientsGetByTenantResponse, ClientsGetByTenantError, ClientsGetByTenantResponse, ReturnType<typeof clientsGetByTenantQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await clientsGetByTenant({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: clientsGetByTenantQueryKey(options)
});
...
export const clientsListServiceAccountsQueryKey = (options?: Options<ClientsListServiceAccountsData>) => createQueryKey('clientsListServiceAccounts', options, false, ['Clients']);

/**
 * List all service accounts (client-credentials clients) for the current tenant.
 */
export const clientsListServiceAccountsOptions = (options?: Options<ClientsListServiceAccountsData>) => queryOptions<ClientsListServiceAccountsResponse, DefaultError, ClientsListServiceAccountsResponse, ReturnType<typeof clientsListServiceAccountsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await clientsListServiceAccounts({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: clientsListServiceAccountsQueryKey(options)
});

/**
 * Create a new service account. Returns the client secret which will NOT be shown again.
 */
export const clientsCreateServiceAccountMutation = (options?: Partial<Options<ClientsCreateServiceAccountData>>): UseMutationOptions<ClientsCreateServiceAccountResponse, ClientsCreateServiceAccountError, Options<ClientsCreateServiceAccountData>> => {
    const mutationOptions: UseMutationOptions<ClientsCreateServiceAccountResponse, ClientsCreateServiceAccountError, Options<ClientsCreateServiceAccountData>> = {
        mutationFn: async (fnOptions) => await clientsCreateServiceAccount({
            ...options,
            ...fnOptions,
            throwOnError: true
        })
 ...
 */
export const clientsRevokeServiceAccountMutation = (options?: Partial<Options<ClientsRevokeServiceAccountData>>): UseMutationOptions<unknown, ClientsRevokeServiceAccountError, Options<ClientsRevokeServiceAccountData>> => {
    const mutationOptions: UseMutationOptions<unknown, ClientsRevokeServiceAccountError, Options<ClientsRevokeServiceAccountData>> = {
        mutationFn: async (fnOptions) => await clientsRevokeServiceAccount({
            ...options,
            ...fnOptions,
            throwOnError: true
        })
...
export const clientsGetServiceAccountQueryKey = (options: Options<ClientsGetServiceAccountData>) => createQueryKey('clientsGetServiceAccount', options, false, ['Clients']);

/**
 * Get a specific service account by ID.
 */
export const clientsGetServiceAccountOptions = (options: Options<ClientsGetServiceAccountData>) => queryOptions<ClientsGetServiceAccountResponse, ClientsGetServiceAccountError, ClientsGetServiceAccountResponse, ReturnType<typeof clientsGetServiceAccountQueryKey>>({
    queryFn: async ({ queryKey, signal }) => await clientsGetServiceAccount({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true
    }),
    queryKey: clientsGetServiceAccountQueryKey(options)
});
...
export const clientsUpdateServiceAccountScopesMutation = (options?: Partial<Options<ClientsUpdateServiceAccountScopesData>>): UseMutationOptions<unknown, ClientsUpdateServiceAccountScopesError, Options<ClientsUpdateServiceAccountScopesData>> => {
    const mutationOptions: UseMutationOptions<unknown, ClientsUpdateServiceAccountScopesError, Options<ClientsUpdateServiceAccountScopesData>> = {
        mutationFn: async (fnOptions) => await clientsUpdateServiceAccountScopes({
            ...options,
            ...fnOptions,
            throwOnError: true
        })
 ...
 */
export const clientsRotateServiceAccountSecretMutation = (options?: Partial<Options<ClientsRotateServiceAccountSecretData>>): UseMutationOptions<ClientsRotateServiceAccountSecretResponse, ClientsRotateServiceAccountSecretError, Options<ClientsRotateServiceAccountSecretData>> => {
    const mutationOptions: UseMutationOptions<ClientsRotateServiceAccountSecretResponse, ClientsRotateServiceAccountSecretError, Options<ClientsRotateServiceAccountSecretData>> = {
        mutationFn: async (fnOptions) => await clientsRotateServiceAccountSecret({
            ...options,
            ...fnOptions,
            throwOnError: true
        })
...
export const setupCompleteSetupMutation = (options?: Partial<Options<SetupCompleteSetupData>>): UseMutationOptions<unknown, SetupCompleteSetupError, Options<SetupCompleteSetupData>> => {
    const mutationOptions: UseMutationOptions<unknown, SetupCompleteSetupError, Options<SetupCompleteSetupData>> = {
        mutationFn: async (fnOptions) => await setupCompleteSetup({
            ...options,
            ...fnOptions,
            throwOnError: true
        })

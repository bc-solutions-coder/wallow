...
function PolicySection({
  ...
  return (
    <section className="space-y-2">
      {/*
        `bodySm` rather than the `heading` scale `as="h3"` derives: these
        section headings are prose-sized labels inside the document body, and
        the derived `text-2xl` would triple them.
      */}

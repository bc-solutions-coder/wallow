 ...
 * (Wallow-ffpq.3.1). This is the direct replacement for Blazor's
...
/**
 * Signals that the web app has hydrated and is interactive.
 *
 * Renders nothing. Instead it stamps `data-app-ready="true"` (and the
 * `web-ready` test id) onto `document.body` from an effect — deliberately

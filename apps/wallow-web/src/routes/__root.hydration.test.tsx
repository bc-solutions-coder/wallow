...
// with no `RouterProvider`. Its focus wiring is asserted in
// `__root.focus.test.tsx`; here it is a render-nothing sentinel so this suite
// keeps testing only the hydration contract.

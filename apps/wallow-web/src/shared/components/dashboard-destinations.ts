...
import { Building2, LayoutGrid, MessageSquare, Settings } from "lucide-react";
 ...
 * `@bc-solutions-coder/navigation` free of an auth dependency. Organizations is
 * the one admin-gated destination.
 *

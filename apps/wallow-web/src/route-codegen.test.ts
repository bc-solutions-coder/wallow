...
/**
 * Route-tree codegen contract for wallow-web (Wallow-w6s6.1.2, T1.2).
 *
...
describe("wallow-web tsr.config.json (CLI codegen config)", () => {
...
describe("wallow-web package.json (routes:generate script + CLI dep)", () => {
...
describe("wallow-web src/routeTree.gen.ts (committed generator output)", () => {
  ...
  it("is real generated output that exports the routeTree", () => {
    ...
    // the simplified router.tsx (T1.4) will import.

...
namespace Wallow.Identity.Infrastructure.Migrations
{
    ...
    [Migration("20260907165951_AddTelemetryRegistrations")]
    partial class AddTelemetryRegistrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Wallow.Identity.Domain.Entities.RegisteredClient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("registered_clients", "identity");
                });

            modelBuilder.Entity("Wallow.Identity.Domain.Entities.SsoSessionClient", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Sid", "ClientId")
                        .IsUnique();

                    b.ToTable("sso_session_clients", "identity");
                });

            modelBuilder.Entity("Wallow.Identity.Domain.Entities.TelemetryRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("AccessState")
                        ...
                        .HasColumnName("access_state");

                    b.Property<long>("AcknowledgedRevision")
                        .HasColumnType("bigint")
                        .HasColumnName("acknowledged_revision");
                    ...
                    b.Property<DateTimeOffset?>("PreviousCredentialExpiresAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("previous_credential_expires_at");

                    b.Property<string>("PreviousCredentialId")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("previous_credential_id");

                    b.Property<string>("PreviousVerifier")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("previous_verifier");
                    ...
                    b.ToTable("telemetry_registrations", "identity");
                });

...
public sealed class AuthApiClientTests : IDisposable
{
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/login")
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/register")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/forgot-password")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/auth/verify-email*")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/reset-password")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/auth/redirect-uri/validate*")
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/auth/external-providers")
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/organization-domains/match*")
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/membership-requests")
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/passwordless/magic-link")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/auth/passwordless/magic-link/verify*")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/passwordless/otp")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/passwordless/otp/verify")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/auth/mfa/verify")
            .Respond("application/json", """{"succeeded":true}""");
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/invitations/verify/*")
    ...
    {
        _mockHttp.When(HttpMethod.Post, "http://localhost:5000/v1/identity/invitations/*/accept")
            .Respond(HttpStatusCode.OK);
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/apps/consent-info/my-client*")
            .Respond("application/json",
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/apps/consent-info/unknown-client*")
            .Respond(statusCode);
    ...
    {
        _mockHttp.When(HttpMethod.Get, "http://localhost:5000/v1/identity/apps/consent-info/my%20client%26co*")
            .Respond("application/json",

...
public sealed class OrganizationDetailPage
{
    ...
    {
        await _page.Locator("[data-testid='organization-detail-register-display-name']").FillAsync(name);
        await _page.Locator("[data-testid='organization-detail-register-client-type']").SelectOptionAsync(type);

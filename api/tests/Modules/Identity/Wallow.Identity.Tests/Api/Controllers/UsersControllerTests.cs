...
public class UsersControllerTests
{
    ...
    public async Task AssignRole_ReturnsNoContent()
    {
        ...
        result.Should().BeOfType<NoContentResult>();
        await _userManagement.Received(1).AssignRoleAsync(userId, _testTenantGuid, "admin", Arg.Any<Guid>(), Arg.Any<CancellationToken>());
    }
    ...
    public async Task RemoveRole_ReturnsNoContent()
    {
        ...
        result.Should().BeOfType<NoContentResult>();
        await _userManagement.Received(1).RemoveRoleAsync(userId, _testTenantGuid, "admin", Arg.Any<Guid>(), Arg.Any<CancellationToken>());
    }

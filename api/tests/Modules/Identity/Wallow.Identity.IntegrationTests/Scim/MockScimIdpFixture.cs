...
public class MockScimIdpFixture : IAsyncLifetime
{
    ...
    {
        // POST /admin/realms/wallow/users - Create user
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users")
                .UsingPost())
            .RespondWith(Response.Create()
                .WithCallback(request =>
                {
                    ...
                    return new WireMock.ResponseMessage
                    {
                        ...
                        {
                            { "Location", new WireMock.Types.WireMockList<string>($"/admin/realms/wallow/users/{user.Id}") }
                        }
                    };
                }));
    }
    ...
    {
        // GET /admin/realms/wallow/users/{id} - Get user by ID
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users/*")
                .UsingGet())
    ...
    {
        // PUT /admin/realms/wallow/users/{id} - Update user
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users/*")
                .UsingPut())
    ...
    {
        // DELETE /admin/realms/wallow/users/{id} - Delete user
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users/*")
                .UsingDelete())
    ...
    {
        // GET /admin/realms/wallow/users?first=X&max=Y&username=... - List users
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users")
                .UsingGet())
    ...
    {
        // GET /admin/realms/wallow/users/count - Get user count
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users/count")
                .UsingGet())
            .AtPriority(0)
            .RespondWith(Response.Create()
                .WithCallback(_ =>
    ...
    {
        // POST /admin/realms/wallow/organizations/*/members - Add user to org (accept silently)
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/organizations/*/members")
                .UsingPost())
            .RespondWith(Response.Create()
                .WithStatusCode(204));
    }
    ...
    {
        // GET /admin/realms/wallow/roles/* - Get realm role (return 404 to skip role assignment)
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/roles/*")
                .UsingGet())
            .RespondWith(Response.Create()
                .WithStatusCode(404));

        // POST /admin/realms/wallow/users/*/role-mappings/realm - Assign role (accept silently)
        _server!
            .Given(Request.Create()
                .WithPath("/admin/realms/wallow/users/*/role-mappings/realm")
                .UsingPost())
            .RespondWith(Response.Create()
                .WithStatusCode(204));
    }
